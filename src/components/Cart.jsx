...
const Cart = ({ cartItems, onRemoveFromCart }) => {
  ...
  return (
    <div className=" p-8 border border-gray-300 rounded-xl text-center bg-white">
      <h2 className=' text-2xl font-semibold border-b border-gray-400 mb-[2rem] pb-2'>ตะกร้าสินค้า</h2>
      {cartItems.length === 0 ? (
        ...
        <>
          ...
          <h3 className='pt-3'>ราคารวมทั้งหมด: ฿{totalPrice.toFixed(2)}</h3>

          <div className="coupon-section ">
            <h3>เลือกส่วนลด</h3>
            <div className="discount-buttons flex justify-center items-center">
